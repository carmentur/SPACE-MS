...
SPACE-MS is a repository of python and matlab tools that enable spatial analysis of tissue damage distribution in multiple sclerosis. The lead developer is Dr Carmen Tur, Senior post-doctoral [https://becarios.fundacionlacaixa.org/en/carmen-tur-gomez-B005083](La Caixa Fellow) at [https://www.cem-cat.org/](Centre d'Esclerosi Múltiple de Catalunya). Please feel free to contact her regarding SPACE-MS at [<ctur@cem-cat.org>](mailto:ctur@cem-cat.org).
